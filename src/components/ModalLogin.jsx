...
const ModalLogin = (props) => {
    ...
    console.log("CEEEK PROPS MODAL LOGIN", props)
    return (
        <>
            <span onClick={() => setShowLogin(true)} style={{ color: "blue", cursor: "pointer" }}>Log In</span>
                ...
                <Modal.Body className="modalLoginBody ml-auto mr-auto">
                    ...
                    <Form>
                        <Form.Group controlId="formBasicEmail">
                            ...
                            <Form.Control type="text" name="userName" placeholder="USERNAME" style={{ width: "100%", height: "48px", borderRadius: "0px" }} onChange={(el) => props.changeInput(el)} />
                        </Form.Group>
                        <Form.Group controlId="formBasicPassword">
                            <Form.Label><strong>PIN</strong></Form.Label>
                            <Form.Control type="password" name="pin" placeholder="PIN" style={{ width: "100%", height: "48px", borderRadius: "0px" }} onChange={(el) => props.changeInput(el)} />
                        </Form.Group>
                        <div style={{ textAlign: "right" }}>
                            <p style={{ fontSize: "1.2rem", fontWeight: "700", cursor: "pointer", color: "blue" }}>Forgot password?</p>
                        </div>
                        <Button variant="primary" type="submit" style={{ width: "100%", height: "48px", borderRadius: "0px" }} className="mb-3" onClick={props.doLogin}>
                            Log in
                        </Button>
                    </Form>
                    <div style={{ textAlign: "center", marginBottom: "25px" }}>
                ...
                <Modal.Body className="modalLoginBody ml-auto mr-auto">
                    ...
                    <Form>
                        <Form.Group controlId="formBasicEmail">
                            ...
                            <Form.Control type="text" name="fullName" placeholder="FULLNAME" style={{ width: "100%", height: "48px", borderRadius: "0px" }} onChange={(el) => props.changeInput(el)} />
                        </Form.Group>
                        <Form.Group controlId="formBasicEmail">
                            <Form.Label><strong>USERNAME</strong></Form.Label>
                            <Form.Control type="text" name="userName" placeholder="USERNAME" style={{ width: "100%", height: "48px", borderRadius: "0px" }} onChange={(el) => props.changeInput(el)} />
                        ...
                        <Button variant="primary" type="submit" style={{ width: "100%", height: "48px", borderRadius: "0px" }} className="mb-3" onClick={props.doSignup}>
                            Join for Free
                        </Button>
                    </Form>
                    <div style={{ textAlign: "center", marginBottom: "25px" }}>
